...
describe('Gilded Rose', function () {
    ...
    it('quality and sellIn decreases by 1', function () {
        const gilgedRose = new Shop([new Item('An Item', 1, 10)]);
    ...
    it('once the sell by date has passes quality decreases twice as fast', function () {
        const gilgedRose = new Shop([new Item('An Item', 0, 10)]);
    ...
    it('the quality of an item is never negative', function () {
        const gilgedRose = new Shop([new Item('An Item', 0, 0)]);
    ...
    it('Aged Brie increases in quality the older it gets', function () {
        const gilgedRose = new Shop([new Item('Aged Brie', 1, 10)]);
    ...
    it('the quality of an item is never more than 50', function () {
        const gilgedRose = new Shop([new Item('Aged Brie', 1, 50)]);
    ...
    it('Sulfuras never has to be sold or decreases in quality ', function () {
        const gilgedRose = new Shop([new Item('Sulfuras, Hand of Ragnaros', 1, 10)]);
    ...
    it('Backstage passes increases in quality by 2 when there are 10 days or less', function () {
        const gilgedRose = new Shop([new Item('Backstage passes to a TAFKAL80ETC concert', 10, 10)]);
    ...
    it('Backstage passes increases in quality by 3 when there are 5 days or less', function () {
        const gilgedRose = new Shop([new Item('Backstage passes to a TAFKAL80ETC concert', 5, 10)]);
    ...
    it('Backstage passes drops quality to 0 after concert', function () {
        const gilgedRose = new Shop([new Item('Backstage passes to a TAFKAL80ETC concert', 0, 10)]);
